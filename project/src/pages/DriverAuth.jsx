...
import { Car, User, Mail, Lock, Phone, FileText, Truck } from 'lucide-react';
...
const DriverAuth = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let success = false;
      if (isLogin) {
        success = await login(formData.email, formData.password, 'driver');
      } else {
        success = await register(formData, 'driver');
      }
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-white/20">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-2">
              {isLogin ? 'Driver Portal' : 'Become a Driver'}
            </h2>
            <p className="text-gray-600">
              {isLogin ? 'Access your driver dashboard' : 'Join our community of professional drivers'}
            </p>
          </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                      placeholder="e.g., Toyota Camry 2020 - ABC123"
                      required
                    />
                  </div>
                </div>
