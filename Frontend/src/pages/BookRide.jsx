...
const BookRide = () => {
    ...
    const handleBookRide = async () => {
        ...
        try {
            ...
            // Simulate driver search delay (if driverId is null initially, this simulates finding one)
            // If driverId is already returned from the /rides/book endpoint, this delay is just for UX
            ...
            // 3. Navigate to the new ride tracking page
            navigate(`/ride-tracking/${newRideId}`, {
                state: {
                    rideDetails: { // Pass essential details to MapPage to avoid re-fetching immediately
                        id: newRideId,
                        ...
                        status: 'ASSIGNED' // Initial status for tracking page
                    }
                }
            });
